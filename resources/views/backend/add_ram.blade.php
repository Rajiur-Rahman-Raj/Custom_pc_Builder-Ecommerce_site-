        ...
        <div class="col-md-12">
            <div class="card mt-3">
                <div class="card-header bg-info text-white rounded">
                    <div class="row">
                        <div class="col-md-6">
                            <h5><i class="fas fa-memory"></i> Add New RAM</h5>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{url('add/ram')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bus_speed" class="form-control" placeholder="Bus Speed" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
